<?php
$title = $title ?? 'Daftar Laporan Camat - LaporBup';
        ...
        <div class="search-section">
            <form method="GET" action="index.php" class="search-form">
                ...
                <div class="search-input-group">
                    <input type="text"
                           name="search"
                           placeholder="Cari nama pelapor, desa, atau uraian..."
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="activity-name">
                                    <?php echo htmlspecialchars($item['nama_desa']); ?>
                                </div>
                            </td>
                            <td>
                                <div class="activity-name">
                                    <?php echo htmlspecialchars($item['nama_kecamatan']); ?>
                                </div>
                            </td>
                            <td>
                                ...
                                <div class="action-buttons">
                                    ...
                                    <?php if ($_SESSION['role'] === 'camat' && $item['status_laporan'] === 'baru' && $item['id_user'] == $_SESSION['user_id']): ?>
                                        <button type="button"
                                                ...
                                                title="Hapus Laporan"
                                                onclick="confirmDelete(<?php echo $item['id_laporan_camat']; ?>)">
