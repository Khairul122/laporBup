<?php
$title = 'Detail Laporan Camat - LaporBup';
                    ...
                    <div class="detail-content">
                        <div class="detail-item">
                            ...
                            <div class="detail-value">
                                ...
                                <?php echo htmlspecialchars($laporan['nama_pelapor']); ?>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="detail-content">
                        <div class="detail-item">
                            ...
                            <div class="detail-value">
                                ...
                                <?php echo htmlspecialchars($laporan['nama_desa']); ?>
                            </div>
                        </div>
                        <div class="detail-item">
                ...
                <div class="detail-content">
                    <div class="detail-item">
                        ...
                        <div class="detail-value">
                            ...
                            <?php echo date('d F Y H.i', strtotime($laporan['waktu_kejadian'])); ?>
                        </div>
                    </div>
                    <div class="detail-item">
