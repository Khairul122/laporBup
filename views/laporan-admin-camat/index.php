...
<body class="with-welcome-text">
            ...
            <div class="col-12">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Laporan Camat</li>
                </ol>
              </nav>
              ...
              <div class="card mb-4">
                <div class="card-body">
                  <form method="GET" action="<?= route('laporanCamatAdmin', 'index') ?>" id="filterForm">
                    <div class="row g-3">
                      <div class="col-md-3">
                          ...
                          <tr>
                            <td colspan="6" class="text-center py-5">
                              <div class="empty-state">
                                ...
                                <a href="<?= route('laporanCamatAdmin', 'index') ?>" class="btn btn-outline-primary btn-sm">
                            ...
                            <tr>
                              ...
                              <td class="text-center">
                                <div class="btn-group btn-group-sm">
                                  ...
                                  <a href="<?= route('laporanCamatAdmin', 'edit', ['id' => $laporan['id_laporan_camat'] ?? '']) ?>"
  ...
  <div class="modal fade" id="statusModal" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form method="POST" action="<?= route('laporanCamatAdmin', 'updateStatus') ?>" id="statusForm">
  ...
  <script>
    ...
    function viewDetail(id) {
      window.location.href = `<?= route('laporanCamatAdmin', 'detail') ?>/${id}`;
    }

    
    function editLaporan(id) {
      window.location.href = `<?= route('laporanCamatAdmin', 'edit') ?>/${id}/edit`;
    }
