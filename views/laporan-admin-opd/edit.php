            ...
            <div class="col-12">
              ...
              <?php if ($laporan): ?>
                    ...
                    <div class="row align-items-center">
                      <div class="col-md-8">
                        <div class="d-flex align-items-center">
                          ...
                          <div>
                            <h2 class="mb-1">Edit Laporan OPD</h2>
                            <p class="text-muted mb-0"><?php echo htmlspecialchars($laporan['nama_opd']); ?></p>
                          </div>
                        </div>
                      </div>
                ...
                <form method="POST" enctype="multipart/form-data" id="editForm">
                  <input type="hidden" name="id_laporan_opd" value="<?php echo $laporan['id_laporan_opd']; ?>">
                        ...
                        <div class="card-body">
                          ...
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nama_opd" name="nama_opd"
                                   value="<?php echo htmlspecialchars($laporan['nama_opd']); ?>"
                      ...
                      <div class="card mb-4">
                        ...
                        <div class="card-body">
                          <div class="d-grid gap-2">
                            ...
                            <a href="<?= route('laporanOPDAdmin', 'index') ?>"
                               class="btn btn-outline-secondary">
              ...
              <?php else: ?>
                ...
                <div class="card">
                  <div class="card-body text-center py-5">
                    ...
                    <a href="<?= route('laporanOPDAdmin', 'index') ?>" class="btn btn-primary">
  ...
  <script>
    ...
    if (editForm) {
      editForm.addEventListener('submit', function(e) {
        ...
        if (!namaOPD.trim()) {
          showFieldError('nama_opd', 'Nama OPD harus diisi!');
          return false;
        }
    ...
    let autoSaveTimer;
    const draftKey = 'laporan_draft_<?php echo $laporan['id_laporan_opd'] ?? 0; ?>';
