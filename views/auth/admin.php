...
<head>
    ...
    <meta name="description" content="Masuk sebagai Administrator — Sistem Layanan Pelaporan Pemerintah Kabupaten Mandailing Natal.">
    <title><?= htmlspecialchars($appData['title']) ?> — Administrator</title>
    ...
    <style>
        :root {
            ...
            --prestige-gold:   #B8976C; /* Antique Gold */
        ...
        *, *::before, *::after {
        ...
        .context-panel::before {
            ...
            position: absolute;
            inset: 0;
            background: radial-gradient(circle at 85% 15%, rgba(184, 151, 108, 0.15) 0%, transparent 60%);
            pointer-events: none;
        }
    ...
    <div class="split-core">
        ...
        <aside class="context-panel">
            ...
            <div class="context-main">
                <span class="role-tag-pill">Administrator</span>
                
                <h1 class="context-title">
                    <?= htmlspecialchars($appData['name']) ?><br>
                    <em><?= htmlspecialchars($appData['description']) ?></em>
                </h1>
                <p class="context-desc">Akses penuh otentikasi administrator untuk mengawasi operasional pelaporan daerah.</p>
                ...
                <div class="feature-list" role="list">
                    <div class="feature-item" role="listitem">
                        ...
                        <div class="feature-body">
                            <div class="feature-title">Manajemen Laporan</div>
                            <div class="feature-desc">Monitor semua antrean laporan OPD dan wilayah kecamatan.</div>
                        </div>
                    </div>
                    <div class="feature-item" role="listitem">
                        <div class="feature-symbol-shell">
                        ...
                        <div class="feature-body">
                            <div class="feature-title">Pengelolaan Pengguna</div>
                            <div class="feature-desc">Atur kewenangan, batasi akses akun dinas dan kecamatan.</div>
                        </div>
                    </div>
                    <div class="feature-item" role="listitem">
                        <div class="feature-symbol-shell">
                        ...
                        <div class="feature-body">
                            <div class="feature-title">Ekspor Rekapitulasi</div>
                            <div class="feature-desc">Unduh berkas laporan dalam format PDF atau Excel.</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <main class="form-panel">
            <div class="form-header">
                ...
                <p>Silakan masukkan kredensial administrator utama.</p>
            </div>
...
<script>
    ...
    document.getElementById('pwdToggle').addEventListener('click', function() {
        ...
        // Exact eye-slash / eye vector path update
    ...
    document.getElementById('loginForm').addEventListener('submit', async function(e) {
        ...
        try {
            ...
            fd.append('login_role', 'admin');
            
            const res    = await fetch('<?= route('auth', 'login') ?>', { method: 'POST', body: fd });
            const result = await res.json();
            if (result.success) {
                showToast('Login Berhasil', 'Mengalihkan Anda ke dashboard administrator…', 'success');
